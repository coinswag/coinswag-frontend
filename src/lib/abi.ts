export const merchStoreFactoryAbi = [
  {
    type: "constructor",
    inputs: [
      {
    ...
    outputs: [
      {
        name: "",
        type: "tuple",
        internalType: "struct MerchStoreFactory.StoreInfo",
        components: [
          {
            name: "storeAddress",
            type: "address",
  ...
  {
    type: "function",
    name: "updateAllStoresPaymentToken",
    inputs: [
      {
  ...
  {
    type: "event",
    name: "StoreOwnershipTransferred",
    inputs: [
      {
        name: "storeId",
        type: "uint256",
